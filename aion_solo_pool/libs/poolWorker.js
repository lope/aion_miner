                ...
                Object.keys(proxySwitch[switchName].ports).forEach(function(port){
                    var f = net.createServer(function(socket) {
                        ...
                        if (pools[currentPool])
                            {
                             let thisServer = pools[currentPool].getStratumServer();
                             console.log(`typeof thisServer`, typeof thisServer, thisServer);
                             console.log(`thisServer`); for (let item in thisServer) console.log(item);
                             thisServer.handleNewClient(socket);
                            }
                        else
                            {
                             let thisServer = pools[initalPool].getStratumServer();
                             console.log(`typeof thisServer`, typeof thisServer, thisServer);
                             console.log(`thisServer`); for (let item in thisServer) console.log(item);
                             thisServer.handleNewClient(socket);
                            }
